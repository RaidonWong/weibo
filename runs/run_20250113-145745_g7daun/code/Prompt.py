...
class Prompts:
    ...
    action_parser = MarkdownJsonDictParser(
        content_hint={
            ...
            "action": "what actions you take in this time. There are several kinds of actions you can choose from. 1: remark:post a remark on others'remark or original post. 2:like:like the post. 3.retweet. 4.post:post a new tweet. 5.stay silence",
