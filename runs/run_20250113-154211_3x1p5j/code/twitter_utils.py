...
def mysequentialpipeline(
    ...
    twitter_page[len(twitter_page)]=twitterpage_todict(msg.to_dict())
...
def twitterpage_todict(twitter_page,like,retweet):
    # 创建一个新的字典来存储提取的内容
    result = {}
...
def update_page_num(msg, like, retweet):
    ...
    # 如果metadata为'like'，则增加like计数
    if metadata == 'like':
        like += 1
    # 如果metadata为'retweet'，则增加retweet计数
