...
from initialization import load_agent, load_environment, prepare_task_config
from agentscope.manager import ASManager
openai_logger = logging.getLogger("openai")
openai_logger.setLevel(logging.WARNING)
from Prompt import Prompts
from twitter_utils import set_parsers

class Simulation_Align:
    def __init__(self, agents: List[AgentBase], environment: BaseEnvironment, context:List, ckpt_dir:str="/root/wangliang/AgentSpace/AgentSpace-main/twitter/ckpt"):
        self.agents = agents
