...
from initialization import load_agent, load_environment, prepare_task_config, load_abm_model
...
class Simulation_Align:
    def __init__(self, agents: List[AgentBase], environment: BaseEnvironment, context:List, ckpt_dir:str):
        self.agents = agents
